...
@Entity
public class ImageCommand implements Parcelable {
    @PrimaryKey
    @NonNull
    public String uuid;
    ...
    private ImageCommand(String uuid, String buyanswerUuid, String type, Content content, CommandStatus commandStatus, long created) {
        this.uuid = uuid;
    ...
    public static final class Builder {
        ...
        public ImageCommand build() {
            ...
            ImageCommand command = new ImageCommand(uuid, buyanswerUuid, type, content, commandStatus, created);
            return command;
        }
    }
    ...
    @Ignore
    public ImageCommand(Parcel in) {

    }

    public static final Creator<ImageCommand> CREATOR = new Creator<ImageCommand>() {
        @Override
        public ImageCommand createFromParcel(Parcel in) {
            return new ImageCommand(in);
        }

        @Override
        public ImageCommand[] newArray(int size) {
            return new ImageCommand[size];
        }
    };
